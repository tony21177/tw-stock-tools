...
選股法。「矩陣」= 長期低量橫向箱型盤整後爆量突破:
  - 盤整 3-6 個月、震盪幅度 ≤15%(標準)/≤30%(寬鬆)、盤整期低量沉澱
...
_STRATEGY_NOTE = (
    ...
    "三條件 — ①盤整 3-6 個月(本工具 ≥60 交易日) ②震盪幅度 ≤15%(⭐標準)/"
    "≤30%(☆寬鬆) ③盤整期低量沉澱、突破當天量=箱型均量 2-10 倍。"
...
def render_html(data: dict) -> str:
  ...
  .pos{color:#c0392b;}
    ...
    return (head +
            ...
            f'<p class="small">資料至 {fmt}｜⭐幅度≤15% ☆≤30%｜'
