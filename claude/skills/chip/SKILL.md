...
### ⚠️ 紀律 4b：時間指涉一律用絕對日期(2026-08-06 加,8039 案例)
- **報告開頭必標**:執行時間、各資料源最新日(分點/融資 = T 日、借券餘額 = T 或 T-1)
- 敘事內**禁止單獨使用「今晚/明晚/明日/今日」**這類相對詞 — 一律寫絕對日期+星期,如「08/07(五) 21:30 後」
- 原因:報告的「今日」= 資料基準日,但「今晚」直覺上會被讀成基準日當晚;若執行日已在基準日之後,基準日晚上的資料早就出了 → 讀者以為被叫去等已出爐的資料
- **forward-looking 觀察指示前先自查**:要寫「觀察借券餘額是否連續下降」前,先確認執行當下該資料是否已可得(過了該日 21:30、或執行日>資料日)— 已可得就直接抓來判讀寫進結論,**不准留讀者回家作業**
- 案例:2026-08-06 跑 8039(基準日 08/05,報告已含 08/05 借券餘額),結論卻寫「今晚 21:30 後看借券餘額」→ 該寫「08/06(四)起每晚 21:30 的餘額是否連續下降」
