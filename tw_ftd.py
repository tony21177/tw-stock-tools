...
def render_html(data: dict) -> str:
  ...
  .note{background:#fff9ec;border:1px solid #f0dca8;border-radius:6px;
    ...
    col_glossary = f"""<section>
<h3>📖 事件表各欄意思 + 看它的用意</h3>
<ul class="small" style="line-height:1.8;margin:.2em 0 0 1em;padding:0">
<li><b>FTD 日</b> — 訊號成立那天(當天收盤後就能判定,不是事後回頭標的)。<b>用意</b>:事件錨點;比對當時你在做什麼、市場氣氛如何,建立「FTD 長什麼樣」的手感。</li>
<li><b>漲幅</b> — FTD 當日指數漲幅(門檻 ≥{FTD_PCT}%)。<b>用意</b>:漲幅越大=機構買盤越猛、訊號越強。歷史上<b>特大漲幅(&gt;3~4%)常出現在深修正後的 V 轉</b>(2020-03-25 +3.87%、2025-04-23 +4.50%、2026-04-08 +4.61%);壓線 +1.7X% 的訊號相對弱。</li>
<li><b>量比</b> — FTD 當日量 ÷ 前一日量(規則要求 &gt;1;台股量=成交金額)。<b>用意</b>:確認是「<b>有量的上漲</b>」——沒量的反彈常是空頭回補/跌深反彈,有量才代表機構真金白銀進場。1.00x 是壓線通過(可信度低),1.5x 以上是明顯放量(2012-11-23 1.81x、2015-09-09 1.78x)。</li>
<li><b>反彈第N天</b> — FTD 出現在「嘗試反彈」的第幾天(規則第 ≥{MIN_DAY} 天才算)。<b>用意</b>:<b>第 4~10 天出現最典型</b>(教科書型,底部剛確立);拖到很晚才出現(如 2018-12-27 第45天、2018-06-29 第89天)= 底部磨很久、反彈第一段已走完,此時 FTD 意義偏「趨勢確認」而非「起漲點」,且防線離現價遠、停損空間大,要降低部位對應。</li>
<li><b>修正深度</b> — 進入這波修正後,修正低點距高點的跌幅。<b>用意</b>:①<b>深修正(−20%~−30%)後的成功 FTD,後續空間通常最大</b>(2020-03 −30.0%、2025-04 −27.1% 都接 V 型大反彈);淺修正(−7%)的 FTD 賺幅通常較小。②拿「現在這波的深度」對照歷史哪次最像,估空間。</li>
<li><b>結果 ✓/✗</b> — FTD 後 {FAIL_WIN} 交易日內有沒有跌破反彈防線(✗=失敗,括號為跌破日)。<b>用意</b>:FTD 的成敗判定核心。失敗率約 1/4(見上方回測),<b>✗ 不是雜訊而是資訊</b>——歷史上真正轉強前常出現 2~3 次失敗的 FTD(空頭末段的特徵);若最近一次 FTD 剛失敗,對下一次訊號要更保守。</li>
<li><b>20日後 / 60日後</b> — 從 FTD 日收盤起算,20/60 個交易日後的指數報酬。<b>用意</b>:量化「跟著 FTD 進場」實際會怎樣——成功案例平均賺多少、失敗案例虧多少,建立<b>期望值的手感</b>(對應上方回測統計);也能看出成功 FTD 的獲利多集中在 60 日內的哪段。</li>
</ul>
<p class="small">💡 <b>綜合讀法</b>:最強的 FTD 組合=「深修正 + 第4~10天 + 大漲幅 + 量比&gt;1.3x」(如 2026-04-08);最弱=「淺修正 + 拖很久 + 壓線漲幅 + 量比≈1.0x」。但無論強弱,<b>進場後唯一紀律相同:跌破反彈防線就退出</b>。</p></section>"""
...
第 ≥{MIN_DAY} 天、失敗判定 {FAIL_WIN} 交易日內跌破防線。非買賣訊號。</section>"""
    ...
    return head + "".join(body) + col_glossary + glossary + foot + '</body></html>'
