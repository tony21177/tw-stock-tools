...
def _build_ignition_history_html(target_date: str,
    ...
    return (
        '<table><thead><tr>'
        '<th title="該族群分數從休眠跳到轉強的當日">點火日</th>'
        '<th>族群</th>'
        '<th class="num" title="點火日前一交易日的 sustainability_score">昨</th>'
        '<th class="num" title="點火日當日 sustainability_score (0-100)">今</th>'
        '<th class="num" title="今 - 昨 = 分數跳升幅度">Δ</th>'
        '<th class="num" title="族群成份股檔數，≥7 較不易假點火">子數</th>'
        '<th class="num" title="近 5 日報酬 &gt; 0 的成份股比例">5d 廣度</th>'
        '<th class="num" title="量能比 = 近 5 日均量 / 近 20 日均量，≥0.95 較不易假點火">量比</th>'
        '<th title="依「子數+量比」啟發式判斷的真假機率：&#13;'
        '✅ 子數 ≥7 + 量比 ≥0.95 高機率真&#13;'
        '⚠ 子數 ≤4 假點火風險高&#13;'
        '🟡 其他組合需觀察 1-2 日">預測</th>'
        '<th title="點火後最多 5 個交易日 score 的實際走勢：&#13;'
        '✅ 真 = 後續最高點 ≥ 點火日 × 2 (族群真延燒)&#13;'
        '❌ 假 = 後續 5 日 score 全 0 或最終墜回 0 (1 日噴出即破滅)&#13;'
        '其他 = 倍率不足 2 的中性結果">後 5 日 score 追蹤</th>'
        '<th>領漲 Top 3</th>'
...
<div class="tabs">
  ...
  <div class="tab-group g-stock" title="即時工具頁 (非 cron；單檔輸入框在上方快速查詢列)">
    ...
    <div class="tab-group-items">
      ...
      <a class="tab" href="/foreign-cost" style="text-decoration:none;color:inherit;">🌐 外資成本</a>
      <a class="tab" href="/utility-screen" style="text-decoration:none;color:inherit;">🛡 抗跌領頭羊</a>
      <a class="tab" href="/vcp" style="text-decoration:none;color:inherit;">🌀 VCP</a>
      ...
      <a class="tab" href="/ftd" style="text-decoration:none;color:inherit;">🚀 FTD 反彈確認</a>
      ...
      <a class="tab" href="/event-trading" style="text-decoration:none;color:inherit;">🎯 事件交易</a>
